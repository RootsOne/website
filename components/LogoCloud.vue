<template>
    <div class="partners mx-auto max-w-7xl px-6 lg:px-8" ref="partners">
        ...
        <div
            ...
            <svg class="col-span-2 max-h-12 w-full object-contain lg:col-span-1 grayscale hover:grayscale-0 transition-all duration-300 staggared"
            ...
            <img format="webp" preload
                class="col-span-2 max-h-12 w-full object-contain lg:col-span-1 grayscale hover:grayscale-0 transition-all duration-300 staggared"
            ...
            <img format="webp" preload
                class="col-span-2 max-h-12 w-full object-contain sm:col-start-2 lg:col-span-1 grayscale hover:grayscale-0 transition-all duration-300 staggared"
                src="https://tailwindui.com/img/logos/158x48/savvycal-logo-gray-900.svg" alt="SavvyCal" width="158"
                height="48" />
            <img format="webp" preload
                class="col-span-2 col-start-2 max-h-12 w-full object-contain sm:col-start-auto lg:col-span-1 grayscale hover:grayscale-0 transition-all duration-300 staggared"
