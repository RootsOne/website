<template>
    <div class="partners mx-auto max-w-7xl px-6 lg:px-8" ref="partners">
        <h3 v-if="props.title" class="text-lg text-sky-500 uppercase font-semibold pb-7">
            {{ props.title }}
        </h3>
        <div
            class="grid grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
            <svg class="col-span-2 max-h-12 w-full object-contain lg:col-span-1 grayscale hover:grayscale-0 transition-all duration-300 staggered"
                xmlns="http://www.w3.org/2000/svg" width="158" height="48" fill="#111827">
                <path
            ...
            <img format="webp" preload
                class="col-span-2 max-h-12 w-full object-contain lg:col-span-1 grayscale hover:grayscale-0 transition-all duration-300 staggered"
            ...
            <img format="webp" preload
                ...
                height="48" />
            <img format="webp" preload
                class="col-span-2 max-h-12 w-full object-contain sm:col-start-2 lg:col-span-1 grayscale hover:grayscale-0 transition-all duration-300 staggered"
                src="https://tailwindui.com/img/logos/158x48/savvycal-logo-gray-900.svg" alt="SavvyCal" width="158"
                height="48" />
            <img format="webp" preload
                class="col-span-2 col-start-2 max-h-12 w-full object-contain sm:col-start-auto lg:col-span-1 grayscale hover:grayscale-0 transition-all duration-300 staggered"
    ...
    timeline(
        [
            ...
            [
                ...
                { at: 0.3, delay: stagger(0.1, { start: 0 }), duration: 0.7, easing: [0.17, 0.55, 0.55, 1] }
            ],
        ],
