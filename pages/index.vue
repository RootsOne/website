<template>
    ...
    <div class="bg-white py-24">
        <div class="container mx-auto px-4">
            <div id="features-1" class="features flex flex-wrap justify-around">
                <div class="w-full md:w-1/2 max-w-lg mx-auto md:mx-0 order-2 md:order-1 pt-10 md:pt-0 one" ref="features11">
                ...
                <div class="w-full md:w-1/2 max-w-lg mx-auto md:mx-0 md:pl-10 flex order-1 md:order-2 two" ref="features12">
    ...
    <div class="container mx-auto py-20 px-4 flex flex-wrap justify-around projects">
        <div class="w-full md:w-1/2 max-w-xl mx-auto md:mx-0 description" ref="description">
            <h4 class="text-primary font-semibold uppercase text-base staggared">
                {{ $t('projects') }}
            </h4>
            <h2 class="font-extrabold flex flex-col text-indigo-700 text-4xl pt-1 staggared">
                {{ $t('over_20_years') }}
            </h2>
            <p class="text-gray-500 text-xl pt-4 pb-6 mb-6 border-b border-gray-200 staggared">
                {{ $t('projects_description') }}
            </p>
            <NuxtLink :to="localePath('/projects')" class="text-sky-500 hover:text-sky-600 flex items-center staggared">
                {{ $t('explore_all') }}
